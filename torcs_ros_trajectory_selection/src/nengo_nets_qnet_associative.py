...
def qnet_associative(b_Direct, signal, i_reward, i_time, i_epsilon, i_inhibit, i_output, i_trainingProbe, i_errorScale, n_action, sim_dt, f_learningRate=0.001 ,label=''):
        ...
        with net: 
            ...
            net = create_learning_net(net, i_time, i_inhibit, i_trainingProbe, i_errorScale, n_action, len(signal), q_radius, sim_dt, tau_mid, tau_long);

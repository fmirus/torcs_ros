    ...
    def needForAction_callback(self, msg_action):
        ...
        if (self.b_TrajectoryNeeded == True):
            ...
            if self.b_doSimulateOnce:
                ...
                self.b_doSimultaOnce = False #don't simualte again until this trajectory has been published (which means that the action signal will turn to False)
                print(self.output_prober.probe_vals)
